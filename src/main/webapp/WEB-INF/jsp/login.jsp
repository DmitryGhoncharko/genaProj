        ...
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal needs-validation" action="/controller?command=logincmnd" method="post" novalidate>
                ...
                <div class="form-group">
                    <input type="text" pattern=".{6,35}" class="form-control" id="validationServer03" name="login" placeholder="Login" required="required">
                </div>
                <div class="form-group help">
                    <input type="password" name="password"  pattern="(?=.*[0-9])(?=.*[!@#$%^&*])(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z!@#$%^&*]{6,35}" class="form-control" id="inputPassword" placeholder="Password" required>
                </div>
                <div class="form-group">
