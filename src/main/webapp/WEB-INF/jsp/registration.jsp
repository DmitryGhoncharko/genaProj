        ...
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal" action="/controller?command=registrationcmnd" method="post">
                ...
                <div class="form-group">
                    <input type="text" name="Fname"  pattern=".{6,35}" class="form-control"  placeholder="First Name" required="required">
                </div>
                <div class="form-group">
                    <input type="text" name="Lname"  pattern=".{6,35}" class="form-control"  placeholder="Last Name" required="required">
                </div>
                <div class="form-group">
