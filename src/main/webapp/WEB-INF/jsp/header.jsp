    ...
    <div class="container-fluide">
        <nav class="navbar navbar-expand-lg navbar-dark bg-light">
            <a class="navbar-brand" href="#">
                <img src="<c:url value="${pageContext.request.contextPath}/static/icon.png"/>" width="70" height="65" class="d-inline-block align-top" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <c:if test="${not empty sessionScope.user && sessionScope.user.role eq RolesHolder.CLIENT}">
                        <li class="nav-item">
                            <a class="nav-link" href="/controller?command=recipe">Recipes</a>
                        </li>
                    </c:if>
                </ul>
            </div>
