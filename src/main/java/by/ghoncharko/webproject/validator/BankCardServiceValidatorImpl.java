...
public class BankCardServiceValidatorImpl implements BankCardServiceValidator{
    private BankCardServiceValidatorImpl(){
    }
    ...
    public static BankCardServiceValidatorImpl getInstance(){
        return Holder.INSTANCE;
    }

    private static class Holder {
        private static final BankCardServiceValidatorImpl INSTANCE = new BankCardServiceValidatorImpl();
    }
}
