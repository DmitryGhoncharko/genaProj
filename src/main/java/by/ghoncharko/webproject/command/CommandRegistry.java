...
public class CommandRegistry {
    ...
    private static final CommandRegistry CREATE_RECIPE_REQUEST_COMMAND = new CommandRegistry(CreateRecipeRequestCommand.getInstance(), "recipecmnd",RolesHolder.CLIENT);
